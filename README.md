...
The dev compose file uses a static `RIVET_SECRET_KEY` for local development only. Production installs should use `scripts/install.sh` with a real secret key.
